...
with DAG(
    ...
    CITY = Variable.get("city")               # TO DO: Set the city name to your coordinates' city name

    database = Variable.get("database")           # TO DO: Set the database name
    schema = "raw"
    target_table = Variable.get("target_table")       # TO DO: Set the target table name
